...
public class FlightsPage extends BasePage {
	...
	public FlightsPage setReturningDate() {
		wait.until(ExpectedConditions.elementToBeClickable(returninDate)).clear();
		executor.executeScript("document.getElementById('flight-returning-hp-flight').value='02/08/2020'");
		return this;
	}
